window.addEventListener("DOMContentLoaded", (event) => {
    ...
    playIconContainers.map((cur, i, arr) => {
        cur.style.backgroundImage = "url(/vendor/luria/img/play.svg)";

        cur.addEventListener("click", () => {
            if (playState === "play") {
                audios[i].play();
                cur.style.backgroundImage =
                    "url(/vendor/luria/img/pause.svg)";
                currentIndex = i;
    ...
    muteIconContainers.map((cur, i, arr) => {
        cur.style.backgroundImage = "url(/vendor/luria/img/unmute.svg)";

        cur.addEventListener("click", () => {
            if (muteState === "unmute") {
                cur.style.backgroundImage = "url(/vendor/luria/img/mute.svg)";
                audios[i].muted = true;
                muteState = "mute";
            } else {
                cur.style.backgroundImage =
                    "url(/vendor/luria/img/unmute.svg)";
